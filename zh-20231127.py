...
# Initialisation
workdir=""
datafile="facsko_pythonzh-20231127.txt"
...
a=np.zeros((len(mylist_without_t),3))
...
plt.figure()
plt.scatter(a[:,1], a[:,0], s=1,alpha=0.5, c='k')
...
# Ábra
plt.plot(drArray,'ko',markersize=0.5)
plt.ylim([0,50])
plt.xlim([0,12000])
plt.title("Sebesség")
plt.xlabel("Time [s]")
...
# 20 km/h vagy nagyobb sebességgel? Készıtsen oszlopdiagrammot és olvassa le róla az eredményt.
